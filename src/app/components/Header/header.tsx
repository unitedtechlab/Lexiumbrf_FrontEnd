        ...
        <div className="account-switch">
          ...
          <div className="account-item">
            <div className="account-content">
              <Avatar size="small" src={<Image src={userImage} alt="Marci Fumons" priority width={45} height={45} />} />
              <div className="account-name-wrapper">
                <h4 className="account-name">Marci Fumons</h4>
          ...
          <div className="account-item">
            <div className="account-content">
              <Avatar size="small" src={<Image src={userImage} alt="Arun Varghese" priority width={45} height={45} />} />
              <div className="account-name-wrapper">
                <h4 className="account-name">Arun Varghese</h4>
